                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu" style="right:0">
                            ...
                            <li class="user-body">
                                ...
                                <div class="col-xs-4 text-center">
                                    <a class="btn-link" href="https://pi-hole.net" target="_blank">网站</a>
                                </div>
                                <div class="col-xs-4 text-center">
                                    <a class="btn-link" href="https://github.com/pi-hole/pi-hole/releases" target="_blank">升级</a>
                                </div>
                                <div class="col-xs-12 text-center" id="sessiontimer">
                                    <b>超时时间 <span id="sessiontimercounter"><?php if($auth && strlen($pwhash) > 0){echo $maxlifetime;}else{echo "0";} ?></span></b>
                                </div>
                            </li>
                            <!-- Menu Footer -->
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                <div class="pull-left info">
                    <p>状态</p>
                        ...
                        if ($pistatus == "1") {
                            echo '<a id="status"><i class="fa fa-circle" style="color:#7FFF00"></i> 正常</a>';
                        } elseif ($pistatus == "0") {
                            echo '<a id="status"><i class="fa fa-circle" style="color:#FF0000"></i> 离线</a>';
                        } elseif ($pistatus == "-1") {
                            echo '<a id="status"><i class="fa fa-circle" style="color:#FF0000"></i> DNS服务没有运行</a>';
                        } else {
                            echo '<a id="status"><i class="fa fa-circle" style="color:#ff9900"></i> 未知</a>';
                        }
                        ...
                        {
                            echo '<a id=\"temperature\"><i class="fa fa-circle" style="color:#FF0000"></i> FTL服务离线e</a>';
                        }
                    ?>
                    <br/>
                    <?php
                    echo "<a title=\"Detected $nproc cores\"><i class=\"fa fa-circle\" style=\"color:";
                        ...
                        echo "\"></i> 负载:&nbsp;&nbsp;" . $loaddata[0] . "&nbsp;&nbsp;" . $loaddata[1] . "&nbsp;&nbsp;". $loaddata[2] . "</a>";
                    ?>
                    <br/>
                    <?php
                    echo "<a><i class=\"fa fa-circle\" style=\"color:";
                        ...
                        if($memory_usage > 0.0)
                        {
                            echo "\"></i> 内存使用:&nbsp;&nbsp;" . sprintf("%.1f",100.0*$memory_usage) . "&thinsp;%</a>";
                        }
                        else
                        {
                            echo "\"></i> 内存使用:&nbsp;&nbsp; N/A</a>";
            ...
            <ul class="sidebar-menu">
                ...
                <li<?php if($scriptname === "queries.php"){ ?> class="active"<?php } ?>>
                    <a href="queries.php">
                        <i class="fa fa-file-text-o"></i> <span>解析日志</span>
                    </a>
                </li>
                <li class="treeview<?php if($scriptname === "db_queries.php" || $scriptname === "db_lists.php" || $scriptname === "db_graph.php"){ ?> active<?php } ?>">
                  <a href="#">
                    ...
                    <i class="fa fa-clock-o"></i> <span>历史数据</span>
                  </a>
                  <ul class="treeview-menu">
                    <li<?php if($scriptname === "db_graph.php"){ ?> class="active"<?php } ?>>
                        <a href="db_graph.php">
                            <i class="fa fa-file-text-o"></i> <span>图表</span>
                        </a>
                    </li>
                    ...
                    <li<?php if($scriptname === "db_lists.php"){ ?> class="active"<?php } ?>>
                        <a href="db_lists.php">
                            <i class="fa fa-file-text-o"></i> <span>排行</span>
                        </a>
                    </li>
                  </ul>
                </li>
                ...
                <li<?php if($scriptname === "whitelist"){ ?> class="active"<?php } ?>>
                    <a href="list.php?l=white">
                        <i class="fa fa-pencil-square-o"></i> <span>白名单</span>
                    </a>
                </li>
                <!-- Blacklist -->
                <li<?php if($scriptname === "blacklist"){ ?> class="active"<?php } ?>>
                    <a href="list.php?l=black">
                        <i class="fa fa-ban"></i> <span>黑名单</span>
                    </a>
                </li>
                <!-- Toggle -->
                ...
                <li id="pihole-disable" class="treeview"<?php if ($pistatus == "0") { ?> hidden="true"<?php } ?>>
                  <a href="#">
                    ...
                    <i class="fa fa-stop"></i> <span>关闭服务</span>&nbsp;&nbsp;&nbsp;<span id="flip-status-disable"></span>
                  </a>
                  <ul class="treeview-menu">
                    <li>
                        <a href="#" id="pihole-disable-permanently">
                            <i class="fa fa-stop"></i> <span>停止服务</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" id="pihole-disable-10s">
                            <i class="fa fa-clock-o"></i> <span>停止10秒</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" id="pihole-disable-30s">
                            <i class="fa fa-clock-o"></i> <span>停止30秒</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" id="pihole-disable-5m">
                            <i class="fa fa-clock-o"></i> <span>停止5分钟</span>
                        </a>
                    </li>
                    <li>
                      <a href="#" id="pihole-disable-cst" data-toggle="modal" data-target="#customDisableModal">
                            <i class="fa fa-clock-o"></i> <span>自定义时间</span>
                      </a>
                    </li>
                  </ul>
                ...
                <li id="pihole-enable" class="treeview"<?php if ($pistatus == "1") { ?> hidden="true"<?php } ?>>
                    <a href="#"><i class="fa fa-play"></i> <span id="enableLabel">开启服务</span>&nbsp;&nbsp;&nbsp;<span id="flip-status-enable"></span></a>
                </li>
                <!-- Tools -->
                ...
                <li>
                    <a href="?logout">
                        <i class="fa fa-user-times"></i> <span>退出</span>
                    </a>
                </li>
                <?php } ?>
                <?php } ?>
                ...
                <li>
                    <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=3J2L3Z4DHW9UY" target="_blank">
                        <i class="fa fa-paypal"></i> <span>捐赠</span>
                    </a>
                </li>
                <?php if($auth){ ?>
                <!-- Help -->
