...
<div class="row">
    ...
    <p>显示不同状态消息:</p>
    <ul>
        <li>状态: Current status of the Pi-hole - Active (<i class="fa fa-circle" style="color:#7FFF00"></i>), Offline (<i class="fa fa-circle" style="color:#FF0000"></i>), or Starting (<i class="fa fa-circle" style="color:#ff9900"></i>)</li>
    ...
    <h4>右上角:关于</h4>
    <ul>
        <li>GitHub: 打开 Pi-hole 的Git仓库</li>
